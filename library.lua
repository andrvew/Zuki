...
function components.slider(holder, options, zindex)
    ...
    fill:Create("Image", {
        ...
        Transparency = 0.5,
        ZIndex = zindex + 2,
        Data = 'https://raw.githubusercontent.com/fardrew/Spectra/main/images/cbimage8.png'
    })
...
function components.colorpicker(holder, options, zindex)
    ...
    icon:Create("Image", {
        Size = newUDim2(1, 0, 1, 0),
        ZIndex = zindex - 1,
        Data = 'https://raw.githubusercontent.com/fardrew/Spectra/main/images/cbimage.png'
    })
